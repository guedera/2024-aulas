...
class ImageNode(Node, MobileNetDetector):
    ...
    def __init__(self):
        ...
        self.mobilenet = MobileNetDetector(
            args_prototxt = "/home/guedes/colcon_ws/src/robcomp-util/robcomp_util/config/MobileNetSSD_deploy.prototxt.txt",
            args_model = "/home/guedes/colcon_ws/src/robcomp-util/robcomp_util/config/MobileNetSSD_deploy.caffemodel"
        )
    ...
    def image_callback(self, msg):
        if self.running:
            ...
            _, resultados = self.mobilenet.detect(cv_image)
            ...
            for resultado in resultados:
                ...
                deteccao.cy = (y1+y2)/2
                print(deteccao)
                if deteccao.classe == 'car' or deteccao.classe == 'cat' or deteccao.classe == 'dog':
