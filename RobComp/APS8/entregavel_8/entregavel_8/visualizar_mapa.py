...
def main():
    map = prep_map('/home/guedes/colcon_ws/src/robcomp-24b-aps-8-enzedes/map.pgm')
    height, width = map.shape
    
    # open yaml file and get map metadata
    with open('/home/guedes/colcon_ws/src/robcomp-24b-aps-8-enzedes/map.yaml', 'r') as file:
        for line in file:
