...
class Aruco3d():
    def __init__(self,
            ...
            if camera_matrix is None:
                self.camera_matrix   = np.loadtxt('/home/guedes/colcon_ws/src/robcomp-24b-aps-6-lgaps/entregavel_6/entregavel_6/config/cameraMatrix_realsense.txt', delimiter=',')
                self.camera_distortion   = np.loadtxt('/home/guedes/colcon_ws/src/robcomp-24b-aps-6-lgaps/entregavel_6/entregavel_6/config/cameraDistortion_realsense.txt', delimiter=',')
            else:
...
def main():
    ...
    bgr = cv2.imread("/home/borg/colcon_ws/src/robcomp-24b-aps-6-lgaps/entregavel_6/entregavel_6/img/aruco.jpg")
